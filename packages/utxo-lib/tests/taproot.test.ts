...
describe('taproot utils', () => {
    describe('musig key aggregation', () => {
        ...
        it('aggregates 2 pubkeys', () => {
            ...
            expect(taproot.trimFirstByte(aggregatePubkey).toString('hex')).toEqual(
        ...
        it('throws an error if no keys are provided', () => {
            expect(() => taproot.aggregateMuSigPubkeys([])).toThrowError();
        });

        it('throws an error if a single key is provided', () => {
            expect(() =>
                taproot.aggregateMuSigPubkeys([
                    Buffer.from(
                        '02c03b14ebd188344d78ed45a0e4857fc65c7e25f50e0c0d84938220ef37da63d6',
                        'hex',
                    ),
    ...
    describe('taptree construction', () => {
        ...
        it('serializes script size', () => {
            ...
            expect(u8SerSize.toString('hex')).toEqual('01');
            expect(u16SerSize.toString('hex')).toEqual('fd0101');
            expect(u32SerSize.toString('hex')).toEqual('fe01010100');
        });
        ...
        it('hashes a tap leaf', () => {
            ...
            expect(tapLeafHash.toString('hex')).toEqual(
        ...
        it('hashes a tap branch', () => {
            ...
            expect(tapBranchHash.toString('hex')).toEqual(
        ...
        it('taptweaks a pubkey', () => {
            ...
            expect(taprootPubkey.toString('hex')).toEqual(
